...
// ✅ paste your full videos array here with src added to each
const videos = [
...
const Video = () => {
  ...
  const video = videos.find((v) => v.id === Number(id));    // ✅ find matching video
  const [message, setMessage] = useState("");

  if (!video) return <p>Video not found</p>;                // ✅ handle no match

  return (
    <div className="video">
      <div className="videoPostSection">
        <div className="video_youtube">
          <video key={video.id} controls autoPlay className="video_youtube_video"> {/* ✅ key forces remount */}
        ...
        <div className="video_youtubeAbout">
          <div className="video_uTubeTitle">{video.title}</div>  {/* ✅ dynamic */}
          ...
          <div className="youtube_video_ProfileBlock">
            <div className="youtube_video_ProfileBlock_left">
              ...
              <div className="youtubeVideo_subsView">
                <div className="youtubePostProfileName">{video.channel}</div>  {/* ✅ dynamic */}
          ...
          <div className="youtubeCommentSection">
            ...
            {/* your existing comments JSX stays exactly the same */}

            <div className="youtubeothersComments">
              <div className="youtubeSelfComment">
                <img
                  className="video_youtubeSelfCommentProfile"
                  src="https://th.bing.com/th/id/OIP.8gLtXrl4KYPfPA6QyMnlUwHaEK?w=304&h-180&c-7&r-0&o-S&dpr-1.3&pid-1.7"
                />
      ...
      {/* your existing videoSuggestions JSX stays exactly the same */}

      <div className="videoSuggestions">
        <div className="videoSuggestionsBlock">
          <div className="video_suggestion_thumbnail">
            <img
              src="https://i.ytimg.com/vi/x-FLu8sOt_U/maxresdefault.jpg"
